...
function UpdatePsycho(props) {
  ...
  const update = async () => {
    ...
    try {
      await Axios.post(
        `http://localhost:8000/api/psychologist/${props.id}?_method=PUT`,
        data,
        {
          headers: {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        value={nameAr}
        type="text"
        placeholder="enter new Arabic name"
        onChange={(e) => {
      ...
      <input
        ...
        style={{ margin: "5% auto" }}
        value={descriptionAr}
        placeholder="enter new Arabic Description"
        onChange={(e) => {
      ...
      <input
        ...
        style={{ margin: "5% auto" }}
        value={descriptionEn}
        placeholder="enter new English Description"
        onChange={(e) => {
