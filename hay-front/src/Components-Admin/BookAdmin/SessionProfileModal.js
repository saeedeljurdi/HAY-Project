...
function SessionModal(props) {
  ...
  return (
    <div className="sessionmodal" >
      <p><span style={{ fontWeight: "bold" }}>English name :</span>{props.dataa.name_en}</p>
      <p><span style={{ fontWeight: "bold" }}>Arabic name :</span>{props.dataa.name_ar}</p>
      {props.dataa.image === "empty" ? (
        <img style={{ width: "30%" }} src={Session} alt="error_profile" />
      ) : (
          <img style={{ width: "30%" }}
